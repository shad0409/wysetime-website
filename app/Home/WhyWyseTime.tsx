            ...
            <div className="why-wyse-features">
                <div className="why-wyse-row">
                    <div className="why-wyse-feature">
                        <Image src={easyIntegrationsIcon} alt="Easy Integrations" />
                    ...
                    <div className="why-wyse-feature">
                        <Image src={expertSupportIcon} alt="Expert Support" />
                        <div className="feature-text">
                ...
                <div className="why-wyse-row">
                    <div className="why-wyse-feature">
                        <Image src={continuouslyImprovedIcon} alt="Continuously Improved" />
                        <div className="feature-text">
                    ...
                    <div className="why-wyse-feature">
                        <Image src={flexibleDeploymentIcon} alt="Flexible Deployment" />
                        <div className="feature-text">
